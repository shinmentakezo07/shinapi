    ...
    >
      ...
      <div className="relative mb-10 rounded-3xl overflow-hidden border border-white/[0.07] shadow-[0_24px_80px_-24px_rgba(99,102,241,0.2),inset_0_1px_0_0_rgba(255,255,255,0.06)]">
        ...
        <motion.div
          ...
          className="absolute -top-16 -right-16 w-64 h-64 rounded-full bg-indigo-500/[0.06] blur-[80px] pointer-events-none"
        />
        <motion.div
          ...
          className="absolute -bottom-20 -left-20 w-72 h-72 rounded-full bg-violet-500/[0.05] blur-[100px] pointer-events-none"
        />
          ...
          <div className="flex flex-col sm:flex-row sm:items-start sm:justify-between gap-6">
            <div className="flex-1">
              <motion.div
                ...
                className="inline-flex items-center gap-2 mb-5 px-3 py-1.5 rounded-full border border-indigo-500/20 bg-indigo-500/[0.06] shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)]"
              >
                <Clock className="w-3 h-3 text-indigo-300" />
                <span className="text-[11px] font-mono font-medium text-indigo-200/80">
                  ~3 minutes to first token
                </span>
              </motion.div>
              <h1 className="text-[2rem] sm:text-[2.5rem] font-semibold tracking-[-0.035em] leading-[1.05] text-white mb-4">
                Quick
                <span className="font-display italic font-normal text-indigo-200/95">
                  start
                </span>
              </h1>
              <p className="text-[15px] text-white/50 leading-[1.85] max-w-lg">
                Yapapa is a single API that fronts every major LLM provider.
                Change the model name, change the vendor. Your code stays the
                same.
              </p>
            </div>
            <motion.div
              ...
              className="flex flex-row sm:flex-col gap-2 sm:items-end flex-shrink-0"
            >
      ...
      >
        ...
        <div className="relative mt-8">
          ...
          <div className="absolute left-[23px] top-12 bottom-12 w-px hidden sm:block">
            <motion.div
              className="w-full bg-gradient-to-b from-violet-400/40 via-indigo-400/40 to-sky-400/40"
              initial={{ height: "0%" }}
              animate={{ height: "100%" }}
...
defer resp.Body.Close()`,
            ...
            {guarantees.map((g, i) => (
              ...
              >
                ...
                <div className="absolute top-4 right-4">
                  <div
                    className={cn(
                      "px-2 py-0.5 rounded-md border text-[10px] font-mono font-bold",
                      g.accentBg,
                      g.accentBorder,
                      g.accentColor,
                    )}
                ...
                <div
                  className={cn(
                    "w-10 h-10 rounded-xl border flex items-center justify-center mb-4 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.05)]",
                    g.accentBorder,
                    g.accentBg,
                  )}
                >
                ...
                <h4 className="text-white/85 text-[13px] font-semibold mb-2">
                  {g.title}
                </h4>
                <p className="text-[12px] text-white/40 leading-[1.7] group-hover:text-white/50 transition-colors">
                  {g.desc}
                </p>
              </motion.div>
            ))}
        ...
        <div className="mt-12 relative rounded-2xl overflow-hidden border border-white/[0.07] bg-gradient-to-br from-white/[0.02] via-transparent to-transparent shadow-[inset_0_1px_0_0_rgba(255,255,255,0.04)]">
          ...
          <div className="relative px-6 py-8 sm:px-8 sm:py-10 flex flex-col sm:flex-row items-start sm:items-center gap-5">
            <div className="flex-1 min-w-0">
              <h4 className="text-white/90 font-semibold text-[15px] mb-1.5">
                Ready to build?
              </h4>
              <p className="text-[13px] text-white/40 leading-[1.7]">
                Explore the full API reference, or jump straight into chat
                streaming with SSE.
              </p>
            </div>
