  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        path: "/api/prompts",
        description:
          "Create a new prompt template with name, content, and optional variables.",
      },
      {
        method: "GET",
        path: "/api/prompts",
      ...
      },
      {
        ...
        description:
          "Render a prompt template with variable substitution and model selection.",
      },
      {
        method: "DELETE",
        path: "/api/prompts/{name}",
      ...
      },
      {
        ...
        description:
          "Get daily and monthly budget limits with current spending.",
      },
      {
        method: "PUT",
        path: "/api/credits/budget",
      ...
      },
      {
        ...
        description: "List budget alert configurations.",
      },
      {
        method: "POST",
        path: "/api/budget/alerts",
        description:
          "Create a budget alert (threshold + notification channel).",
      },
      {
        method: "DELETE",
        path: "/api/budget/alerts/{id}",
        description: "Delete a budget alert.",
      },
      {
        method: "GET",
        path: "/api/budget/cap",
        description: "Get the current budget cap (hard spend limit).",
      },
      {
        method: "POST",
        path: "/api/budget/cap",
        description: "Create a budget cap.",
      },
      {
        method: "PUT",
        path: "/api/budget/cap",
        description: "Update the budget cap.",
      },
      {
        method: "DELETE",
        path: "/api/budget/cap",
      ...
      {
        method: "GET",
        path: "/api/promos/redeem",
        description: "Redeem a promo code for credits.",
      },
      {
        method: "POST",
        path: "/api/validate",
      ...
      },
      {
        ...
        description:
          "Real-time Server-Sent Events (SSE) stream for live notifications.",
      },
      {
        method: "GET",
        path: "/api/messages",
        description: "Get admin-targeted messages for the current user.",
      },
      {
        method: "GET",
        path: "/api/messages/unread-count",
        description: "Count unread targeted messages.",
      },
      {
        method: "POST",
      ...
      },
      {
        ...
        description: "Get active in-app announcements.",
      },
      {
        method: "GET",
        path: "/api/comparisons",
        description: "List model A/B comparisons.",
      },
      {
        method: "POST",
        path: "/api/comparisons",
        description: "Create a model comparison request.",
      },
      {
        method: "GET",
        path: "/api/comparisons/{id}",
        description: "Get comparison details and results.",
      },
      {
        method: "DELETE",
        path: "/api/comparisons/{id}",
      ...
      {
        method: "GET",
        path: "/api/fine-tuning/jobs/{jobId}",
        description: "Get fine-tuning job status.",
      },
      {
        method: "GET",
        path: "/api/fine-tuning/datasets",
        description: "List fine-tuning datasets.",
      },
      {
        method: "POST",
        path: "/api/fine-tuning/datasets",
        description: "Create a fine-tuning dataset.",
      },
      {
        method: "DELETE",
        path: "/api/fine-tuning/datasets/{id}",
      ...
      },
      {
        method: "POST",
        path: "/api/keys/{id}",
        description: "Update API key metadata, scopes, or restrictions.",
      },
      {
        method: "POST",
        path: "/auth/logout",
        description: "Logout and blacklist current session token.",
      },
      {
        method: "DELETE",
        path: "/api/account",
      ...
      },
      {
        ...
        description: "Get current user RBAC permissions.",
      },
      {
        method: "GET",
      ...
      },
      {
        ...
        path: "/api/webhooks",
        description:
          "Create a new webhook endpoint with event types and target URL.",
      },
      {
        method: "GET",
    ...
    endpoints: [
      {
        ...
        description:
          "OpenAI-compatible chat completions endpoint. Accepts standard OpenAI request format with streaming support.",
      },
      {
        method: "POST",
        path: "/v1/embeddings",
        description:
          "OpenAI-compatible embeddings endpoint. Returns embeddings in OpenAI response format.",
      },
      {
        method: "GET",
        path: "/v1/models",
        description:
          "OpenAI-compatible models list. Returns available models in OpenAI format.",
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        ...
        path: "/v1/messages",
        description:
          "Anthropic-compatible Messages API. Supports streaming with Anthropic-native SSE events, tool use, and vision.",
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        ...
        description:
          "[Admin] List all platform users with pagination and search.",
      },
      {
        method: "GET",
        path: "/api/admin/users/{id}",
        description:
          "[Admin] Get detailed user information including role, status, and usage.",
      },
      {
        method: "GET",
      ...
      },
      {
        ...
        description:
          "[Admin] Adjust user credit balance (add or deduct credits).",
      },
      {
        method: "GET",
        path: "/api/admin/settings",
        description:
          "[Admin] Get platform-wide settings including rate limits, features, and branding.",
      },
      {
        method: "PUT",
        path: "/api/admin/settings",
      ...
      },
      {
        ...
        description:
          "[Admin] View circuit breaker states for all LLM providers.",
      },
      {
        method: "GET",
        path: "/api/admin/providers",
        description:
          "[Admin] List all configured LLM providers with health status.",
      },
      {
        method: "POST",
        path: "/api/admin/providers",
      ...
      },
      {
        ...
        description:
          "[Admin] Get platform-wide statistics: total users, requests, credits spent.",
      },
      {
        method: "GET",
        path: "/api/admin/logs",
        description:
          "[Admin] View platform-wide request logs with user context.",
      },
      {
        method: "GET",
        path: "/api/admin/audit-logs",
        description:
          "[Admin] Access audit trail of all admin actions for compliance.",
      },
      {
        method: "GET",
      ...
      },
      {
        ...
        description:
          "[Admin] Get comprehensive analytics data across all users.",
      },
    ],
  },
  {
    ...
    endpoints: [
      {
        ...
        description:
          "Stripe webhook endpoint. Receives payment events (requires Stripe signature verification).",
        auth: false,
      },
    ],
  },
